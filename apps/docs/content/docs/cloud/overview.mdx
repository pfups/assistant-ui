...
Assistant Cloud integrates with your auth provider (Clerk, Auth0, Supabase, Firebase, ...) to identify your users and authorize them to access just the conversations they are allowed to see. In addition to JWT and API Key strategies, Assistant Cloud now also supports anonymous authentication.
