...
Choose direct integration with your auth provider if you can. Otherwise, use a backend server or anonymous authentication as per your requirements.
...
For anonymous authentication, you can use the `AssistantCloudAnonymousAuthStrategy` class. This class handles the process of obtaining and refreshing anonymous tokens.
...
In this configuration, the `AssistantCloud` instance will automatically handle the process of obtaining and refreshing anonymous tokens.